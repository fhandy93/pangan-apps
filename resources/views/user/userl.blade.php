                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="text-success" href="user/{{$user->username}}/profile">{{$user -> username}}</a>
                                                    @else
                                                    {{$user -> username}}
                                                    @endif
                                                </td>
                                                ...
                                                <td>
                                                    <div class="btn-list">
                                                    @if (Auth::user()->username != $user->username)
                                                        <a href=""><button type="button" class="btn btn-xl btn-primary" data-bs-placement="top" data-bs-toggle="tooltip-primary" title="Chat {{$user->username}}"><span  class="fa fa-commenting-o"> </span></button></a>
                                                    @endif
                                                    </div>
                                                </td>
                                            </tr>
