    ...
    <div class="container text-center">
        <div class="error-template">
            ...
            <h5 class="error-details">
                You don't have permission for access this page<br/> Please contact you Superadmin!
            </h5>
            <div class="text-center">
                <a class="btn btn-secondary mt-5 mb-5" href="/home"> <i class="fa fa-long-arrow-left"></i> Back to Home </a>
            </div>
        </div>
    </div>
</div>
